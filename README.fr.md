...
Afin de garantir la compatibilité du système avec les standards cartographiques de la défense, tels que la suite logicielle industrielle **Luciad**, le projet met en oeuvre une architecture hautement découplée reposant sur l'**Inversion de Dépendance** (principes SOLID) :
