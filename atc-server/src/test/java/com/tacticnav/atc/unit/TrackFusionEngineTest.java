...
class TrackFusionEngineTest {
    ...
    void fuse_shouldIgnoreOutOfOrderObservationForExistingTrack() {
        ...
        RadarInputMessage older = new RadarInputMessage((short) 5, 180f, 0f, 5_000f, 1_000L);
    ...
    void fuse_shouldExpireStaleTracksBeforeAssociation() {
        ...
        RadarInputMessage second = new RadarInputMessage((short) 8, 90f, 0f, 1_000f, 7_100L);
